...
def process():
    ...
    for problem in problems:
        ...
        lists = list()
        lists.append(['AL1'] + problem_content['al1']['evals'])
        lists.append(['AL2'] + problem_content['al2']['evals'])
        lists.append(['MMRE'] + problem_content['mmre']['evals'])
        lists.append(['Rank'] + problem_content['rank']['evals'])
