...
def process():
    ...
    for problem in problems:
        ...
        lists = list()
        lists.append(['AL1'] + problem_content['al1']['igd'])
        lists.append(['AL2'] + problem_content['al2']['igd'])
        lists.append(['MMRE'] + problem_content['mmre']['igd'])
        lists.append(['Rank'] + problem_content['rank']['igd'])
