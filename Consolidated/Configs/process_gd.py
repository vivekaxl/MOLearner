...
for i, problem in enumerate(sorted(problems)):
    ...
    lists = list()
    try: lists.append(['AL2'] + al2[problem]['gen_dist'])
    except: pass
    try: lists.append(['AL'] + al[problem]['gen_dist'])
    except:
        pass
    try: lists.append(['MMRE'] + mmre[problem]['gen_dist'])
    except:
        pass
    try: lists.append(['Rank'] + rank[problem]['gen_dist'])
    except:
        pass
    try:lists.append(['epal\_0.01'] + epal_001[problem]['gen_dist'])
    except: pass
    try: lists.append(['epal\_0.02'] + epal_002[problem]['gen_dist'])
    except: pass
    try: lists.append(['epal\_0.04'] + epal_004[problem]['gen_dist'])
    except: pass
    try: lists.append(['epal\_0.08'] + epal_008[problem]['gen_dist'])
    except: pass
    try: lists.append(['epal\_0.16'] + epal_016[problem]['gen_dist'])
    except: pass
    try: lists.append(['epal\_0.20'] + epal_020[problem]['gen_dist'])
    except: pass
    try: lists.append(['epal\_0.30'] + epal_030[problem]['gen_dist'])
    except: pass
