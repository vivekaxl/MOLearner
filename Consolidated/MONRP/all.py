...
for problem in problems:
    ...
    for i, algorithm in enumerate(algorithms):
        if dict['gd'][problem][algorithm][0] == 1:
            print '\cellcolor[HTML]{D1D5DE}', r(dict['gd'][problem][algorithm][1]), '&',
        else: print r(dict['gd'][problem][algorithm][1]), ' &',

        if dict['igd'][problem][algorithm][0] == 1:
            print '\cellcolor[HTML]{D1D5DE}', r(dict['igd'][problem][algorithm][1]), '&',
        else:
            print r(dict['igd'][problem][algorithm][1]), '&',
        if dict['evals'][problem][algorithm][0] == 1:
            print '\cellcolor[HTML]{D1D5DE}', int(dict['evals'][problem][algorithm][1]),
        else:
