...
f, ((ax1, ax2, ax3), (ax5, ax6, ax7)) = plt.subplots(2, 3)


c = pickle.load(open("./ExplainFiguresPickleLocker/llvm_input_1.p"))
...
ax1.scatter([np.log(d[0]) for d in all_data_dep], [np.log(d[1]) for d in all_data_dep], color='r', marker='.')
# ax1.fill(convex_hull_x, convex_hull_y, 'k', alpha=0.3)
# ax1.scatter([np.log(p[0]) for p in compliant_data_dep], [np.log(p[1]) for p in compliant_data_dep], color='yellow', marker='+',
#                label="Explain-PF")
ax1.plot([np.log(p[0]) for p in current_pf], [np.log(p[1]) for p in current_pf], color='green', marker='o',
               label="Predicted-PF")
ax1.plot([np.log(p[0]) for p in actual_pf], [np.log(p[1]) for p in actual_pf], color='blue', marker='v', label="Actual-PF")
ax1.set_title('Iteration 1', fontsize=10)
...
c = pickle.load(open("./ExplainFiguresPickleLocker/llvm_input_4.p"))
all_data_dep = c['all_data_dep']
convex_hull_x = c['convex_hull_x']
convex_hull_y = c['convex_hull_y']
compliant_data_dep = c['complaint_data']
...
# ax2.scatter([np.log(p[0]) for p in compliant_data_dep], [np.log(p[1]) for p in compliant_data_dep], color='yellow', marker='+',
#                label="Explain-PF")
...
ax2.set_title('Iteration 4', fontsize=10)
ax2.set_xlabel('log(f1)', fontsize=10)
ax2.set_ylabel('log(f2)', fontsize=10)

c = pickle.load(open("./ExplainFiguresPickleLocker/llvm_input_8.p"))
all_data_dep = c['all_data_dep']
convex_hull_x = c['convex_hull_x']
convex_hull_y = c['convex_hull_y']
compliant_data_dep = c['complaint_data']
...
# ax3.scatter([np.log(p[0]) for p in compliant_data_dep], [np.log(p[1]) for p in compliant_data_dep], color='yellow', marker='+',
#                label="Explain-PF")
...
ax3.set_title('Iteration 8', fontsize=10)
ax3.set_xlabel('log(f1)', fontsize=10)
ax3.set_ylabel('log(f2)', fontsize=10)

c = pickle.load(open("./ExplainFiguresPickleLocker/llvm_input_12.p"))
all_data_dep = c['all_data_dep']
convex_hull_x = c['convex_hull_x']
convex_hull_y = c['convex_hull_y']
compliant_data_dep = c['complaint_data']
...
# ax5.scatter([np.log(p[0]) for p in compliant_data_dep], [np.log(p[1]) for p in compliant_data_dep], color='yellow', marker='+',
#                label="Explain-PF")
...
ax5.set_title('Iteration 12', fontsize=10)
ax5.set_xlabel('log(f1)', fontsize=10)
ax5.set_ylabel('log(f2)', fontsize=10)

c = pickle.load(open("./ExplainFiguresPickleLocker/llvm_input_15.p"))
all_data_dep = c['all_data_dep']
convex_hull_x = c['convex_hull_x']
convex_hull_y = c['convex_hull_y']
compliant_data_dep = c['complaint_data']
...
# ax6.scatter([np.log(p[0]) for p in compliant_data_dep], [np.log(p[1]) for p in compliant_data_dep], color='yellow', marker='+',
#                label="Explain-PF")
...
ax6.set_title('Iteration 15', fontsize=10)
...
c = pickle.load(open("./ExplainFiguresPickleLocker/llvm_input_16.p"))
all_data_dep = c['all_data_dep']
convex_hull_x = c['convex_hull_x']
convex_hull_y = c['convex_hull_y']
compliant_data_dep = c['complaint_data']
...
ax7.scatter([np.log(d[0]) for d in all_data_dep], [np.log(d[1]) for d in all_data_dep], color='r', marker='.')
# ax7.fill(convex_hull_x, convex_hull_y, 'k', alpha=0.3)
# ax7.scatter([np.log(p[0]) for p in compliant_data_dep], [np.log(p[1]) for p in compliant_data_dep], color='yellow', marker='+',
#                label="Explain-PF")
...
ax7.set_title('Iteration 16', fontsize=10)
...
plt.figlegend([ax1.lines[0], ax1.lines[1]], [ "Predicted-PF", "Actual-PF"], frameon=False, loc='lower center', bbox_to_anchor=(0.48, -0.035), fancybox=True, ncol=2)
f.tight_layout()
plt.savefig('temp_explain.png')