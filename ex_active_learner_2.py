...
def explain_me_cdom(ex_train_indep, ex_train_dep, lessismore_status, all_data_indep, all_data_dep, current_pf, actual_pf, filename):
    """lessismore is a list"""
    ...
    plt.ylabel('log(f2)')
    plt.legend(loc=2)
    plt.savefig('./ExplainFigures/' + filename.split('/')[-1][:-4] + ".png")
    plt.cla()
