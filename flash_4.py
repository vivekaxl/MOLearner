    ...
    for file in files:
        ...
        for rep in xrange(1):
            ...
            while True:
                ...
                selected_n1 = [choice(selected_n1)]
                assert(len(selected_n1) == 1), "Something is wrong"
        ...
        pickle.dump(all_data, open('Flash4_Data/PickleLocker/' + file.split('/')[-1][:-4] + "_" + str(repeat_no) + ".p", "w"))
